admin = Admin.find_or_create_by(first_name: 'Admin', last_name: 'Adminovich', email: 'admin@mail.com')
admin.password = 'default'
admin.save

developer = Developer.find_or_create_by(first_name: 'Developer', last_name: 'Dev', email: 'developer@mail.com')
developer.password = 'default'
developer.save

manager = Manager.find_or_create_by(first_name: 'Manager', last_name: 'Man', email: 'manager@mail.com')
